...
export default function App() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Text style={styles.title}>KITT Mobile v0.4 - READY</Text>
      <Text style={styles.subtitle}>Upload this folder to GitHub and run Actions</Text>
      ...
      <TextInput style={styles.input} placeholder="Typ příkazu..." placeholderTextColor="#888" value={input} onChangeText={setInput} onSubmitEditing={send} />
      ...
      <View style={styles.row}>
        ...
        <TouchableOpacity style={styles.btn} onPress={() => { setInput('Jedeme do Kroměříže'); send(); }}><Text style={styles.btnText}>Kroměříž</Text></TouchableOpacity>
      </View>

      <View style={{height:30}}/>
      <Text style={styles.hint}>GitHub Actions ready — run CI to build APK</Text>
    </SafeAreaView>
  );
}
