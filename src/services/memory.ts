...
export class Memory{constructor(){this.people={};this.driver={drivingStyle:{aggressiveness:3,preferSpeed:110},speakRules:{interrupt:false,musicComments:'mild'}};this.dna={};this.rules=[];} 
